...
export default function ProjectCarousel4() {
  ...
  useEffect(() => {
    const fetchImages = async () => {
      const query = "project management"; // Can adjust as needed
          ...
          <Card className="w-full sm:w-[500px] mx-4">
            <CardContent className="flex items-center justify-center p-4 sm:p-8">
              <Image
                ...
                alt={images[currentImageIndex]?.alt_description || "Project Management"}
                width={300}
                height={300}
            ...
            <CardContent className="flex items-center justify-center p-4 sm:p-8">
              <p className="leading-7 [&:not(:first-child)]:mt-6 font-abel font-light tracking-wide text-center">
                We excel in landscaping, project management, and diverse aspects of building and construction.
              </p>
            </CardContent>
          </Card>
        </div>
