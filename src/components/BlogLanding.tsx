...
const BlogLandingSection = () => {
  ...
  return (
    <div className="relative h-screen w-full flex items-center justify-center">
      ...
      <div className="relative z-20 text-white text-left p-4 hover:text-opacity-100 text-opacity-50 transition duration-300 ease-in-out font-abel font-light tracking-wide ">
