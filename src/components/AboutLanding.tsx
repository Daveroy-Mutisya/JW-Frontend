        ...
        <div className="text-left text-opacity-50 transition duration-300 ease-in-out">
          ...
          <div className="flex flex-col md:flex-row my-5 mx-5 md:mx-20">
            <div className="flex flex-col md:w-1/2 pr-0 md:pr-10">
              ...
              <p className="leading-7 mt-6 text-base sm:text-lg md:text-2xl font-abel font-light tracking-wide hover:text-lime-500">
            ...
            <div className="flex flex-col md:w-1/2 mt-10 md:mt-0">
              <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="item-1">
                  <AccordionTrigger>
                    <p className="leading-7 mt-6 text-base sm:text-lg md:text-2xl font-abel font-light tracking-wide text-lime-500">Vision</p>
                  </AccordionTrigger>
                  <AccordionContent>
                ...
                <AccordionItem value="item-2">
                  <AccordionTrigger>
                    <p className="leading-7 mt-6 text-base sm:text-lg md:text-2xl font-abel font-light tracking-wide text-lime-500">Mission</p>
                  </AccordionTrigger>
                  <AccordionContent>
                    <p className="leading-7 mt-6 text-base sm:text-lg md:text-2xl font-abel font-light tracking-wide">
